...
for root in roots:
    ...
    os.system("./test_log_prob %s %s /Users/enalisnick/Desktop/word2vec/wiki_test_subset.txt %.8f %.8f" %(vecspath+'INPUT_VECS_'+root+'.txt', vecspath+'CONTEXT_VECS_'+root+'.txt', sparsity, dim_penalty))
